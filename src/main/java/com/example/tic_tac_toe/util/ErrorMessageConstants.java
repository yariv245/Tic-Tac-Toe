...
public class ErrorMessageConstants {
    ...
    public final static String WRONG_PASSWORD_MESSAGE = "Wrong passowrd !";
    public final static String FIRST_PLAYER_NOT_FOUND_MESSAGE = "Couldn't find first player id";
    public final static String OPPONENT_NOT_FOUND_MESSAGE = "Coludn't find any Opponent to player: %s";
}
